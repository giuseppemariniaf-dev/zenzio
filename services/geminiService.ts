...
const LANGUAGE_DEFAULTS: Record<string, LanguageConfig> = {
    'Italiano': { 
        ...
        ui: { ...COMMON_UI_DEFAULTS, 
              cardErrorTitle: "Attenzione",
              cardErrorMsg: "Al momento non possiamo accettare pagamenti con carta di credito. Scegli come procedere:",
